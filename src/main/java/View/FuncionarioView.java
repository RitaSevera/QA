...
public class FuncionarioView {
    ...
    public static void menuFuncionario() throws IOException {
        ...
        FuncionarioController funcionarioController = new FuncionarioController("Ficheiros/minimercado.csv");
        ...
        do {
            ...
            switch (opcao) {
                case 1:
                    ...
                    funcionarioController.addVenda(tipoProduto,nomeProduto,quantidadeProduto,precoProduto, path);
                    break;
