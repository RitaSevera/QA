...
public class AdministradorView {
    ...
    public static void menuAdmin() throws IOException {
        ...
        AdministradorController adminController = new AdministradorController("Ficheiros/minimercado.csv");
        ...
        do {
            ...
            switch (opcao) {
                ...
                case 7:
                    ...
                    adminController.adicionarUtilizador(tipoUtilizadorString,nomeUtilizador,password, path);
